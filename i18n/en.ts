...
export const en = {
  ...
  tasks: {
    title: 'Calendar',
    subtitle: 'Track your schedule and forms.',
    upcoming: 'Upcoming',
    pastDue: 'Past Due',
    completeModalTitle: 'Complete Item',
    completeModalMessage: 'Are you sure you want to mark this as complete?',
    completeButton: 'Complete',
    deleteModalTitle: 'Delete Event',
    deleteModalMessage: 'This will permanently remove this event. Are you sure?',
    deleteButton: 'Delete',
    today: 'Today',
    tomorrow: 'Tomorrow',
    inDays: 'In {days} days',
    ...
    color: 'Color',
    priority: 'Priority',
    priorityLow: 'Friendly Reminder',
    priorityNormal: 'Normal',
    priorityImportant: 'Important',
    priorityUrgent: 'Urgent',
    priorityCritical: 'SUPER URGENT',
    filter: 'Filter',
    sourceAll: 'All',
    sourceForm: 'Forms',
    sourceEmail: 'Emails',
